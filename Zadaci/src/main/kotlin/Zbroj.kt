...
private fun zavrsiGranu(){
    ...
    // Ovom funkcijom brisemo od kraja clanove grane sve dok su jednaki vrijednosti najmanjeg broja u odabranoj listi
...
private fun unos(){
    ...
    listaBrojeva.sortDescending()
}

fun main(args: Array<String>) {
    header()
    unos()
    // pokretanje provjere grani stabla pocevsi od najveceg clana liste brojeva
    kombiniraj(0)
